      ...
      <section className="container mx-auto px-5 md:px-8 lg:px-10 max-w-7xl py-16">
        {isLoading ? (
          ...
          {filtered.map(m => (
            <div
              key={m._id}
              className="group relative min-h-[440px] aspect-[4/5] rounded-2xl overflow-hidden cursor-pointer bg-[#0E1528]/90 shadow-[0_4px_24px_rgba(0,0,0,0.4)] hover:shadow-[0_12px_40px_rgba(0,0,0,0.6),0_0_24px_rgba(212,175,55,0.14)] border border-white/[0.10] hover:border-[#D4AF37]/50 transition-all duration-300 hover:-translate-y-1.5 flex flex-col justify-between"
            >
              ...
              <div className="relative p-6 z-10 flex items-center justify-between">
                <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-xl bg-[#060911]/85 backdrop-blur-md border border-white/[0.12] text-[#D4AF37] text-2xs font-bold uppercase tracking-[0.14em] shadow-subtle group-hover:border-[#D4AF37]/40 transition-colors">
              ...
              <div className="relative p-6 lg:p-7 z-10 mt-auto flex flex-col">
                <div className="transform transition-all duration-300 group-hover:-translate-y-0.5">
                  ...
                  <div className="pt-3.5 border-t border-white/[0.08] flex items-center justify-between text-xs font-medium">
                    ...
                    <Link
                      to="/#contato"
                      className="text-slate-200 group-hover:text-[#D4AF37] group-hover:translate-x-0.5 transition-all flex items-center gap-1.5 font-bold"
                    >
        ...
        {/* CTA Banner */}
        <div className="mt-20 rounded-3xl bg-[#0E1528]/90 border border-white/10 p-10 md:p-14 text-center relative overflow-hidden shadow-dark-card backdrop-blur-2xl">
          ...
          <p className="text-slate-300 mb-8 max-w-lg mx-auto text-sm sm:text-base leading-relaxed relative z-10 font-normal">
            Entre em contato conosco e descubra como colocar seus dons em prática na nossa comunidade.
          </p>
          <Link
            to="/#contato"
            className="inline-flex items-center gap-2.5 px-8 py-4 rounded-xl font-bold text-[#060911] bg-[#D4AF37] hover:bg-[#E2BE4B] border border-[#FFF5DC]/60 shadow-[0_2px_10px_rgba(0,0,0,0.3),0_0_18px_rgba(212,175,55,0.22)] hover:shadow-[0_4px_20px_rgba(0,0,0,0.4),0_0_28px_rgba(212,175,55,0.38)] transition-all duration-200 hover:-translate-y-0.5 relative z-10 text-sm"
          >
            Fale Conosco
          </Link>
        </div>
